...
parameters = {
        ...
        "salt":"4446860302761739304752683030156737591518664810215442929817756370764078432657",
...
def create_signature(parameters, private_key):
    ...
    signed_message = Account.sign_typed_data(private_key=PRIVATE_KEY, full_message=message_schema)
